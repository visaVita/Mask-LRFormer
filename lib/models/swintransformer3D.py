...
def build_swin_transformer3D(modelname):
    assert modelname in ['swin3D_B_224_22k', 'swin3D_T_224_1k']
    model_para_dict = {
        'swin3D_B_224_22k': dict(
            depths=[2, 2, 18, 2],
            embed_dim=128,
            num_heads=[4, 8, 16, 32],
            window_size=(8, 7, 7),
        ),
        'swin3D_T_224_1k': dict(
            embed_dim=96,
            depths=[2, 2, 6, 2],
            num_heads=[3, 6, 12, 24],
            window_size=(8,7,7),
    ...
    model = SwinTransformer3D(**model_para_dict[modelname])
    return model